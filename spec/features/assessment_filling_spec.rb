...
#     visit "/student_teams/#{student.student_teams.first.id}"

#     # Should be able to see assessment in the table
#     # expect(page).to have_content "You currently have 1 peer assessments to complete"
...
#     c1 = a.questions.where(single: true).first
#     c2 = a.questions.where(single: false).first
