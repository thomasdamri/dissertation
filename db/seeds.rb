...
#s1task6.save
s1task7 = StudentTask.create(student_team_id: st1.id, task_difficulty: 1, task_start_date: "Thu, 15 feb 2022 11:12:02 +0000", task_target_date: "23 feb 2022", task_objective: "When clicking on a story, the story is opened. The story per se is unmodifiable but it will be possible to discuss about the findings in a chat with another person online when the two users are in the same room at the same time.")
#s1task7.save

#Team member 2
s2task1 = StudentTask.create(student_team_id: st2.id, task_difficulty: 1, task_start_date: "Thu, 19 jan 2022 14:12:02 +0000", task_target_date: "25 jan 2022", task_objective: "It is important for your solution to follow the patterns and material taught during the lectures. Solutions that adopt different approaches will attract low marks and in some cases zero marks. The goal of the assignment is to prove that. ")
#s2task1.save
